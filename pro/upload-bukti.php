    ...
    <section class="content">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title text-primary"><i class="fa fa-upload"> </i> Upload Bukti Transfer</h3>
        ...
        <!-- form start -->
            <form class="form-horizontal" enctype="multipart/form-data" method="post" action="proses-upload-bukti.php?id=<?php echo $_GET['id'];?>">
              <div class="row">
			   <div class="col-lg-6 col-xs-12">
			  <div class="box-body">
					<?php 
						$result = $mysqli->query("SELECT *  FROM `pesan` WHERE `id_pesan` = ".$_GET['id']."");
							while ($row = $result->fetch_assoc()) {
					?>
                <div class="form-group">
                  <label for="user" class="col-sm-3 control-label">Tiket</label>

                  <div class="col-sm-9">
                    <input type="text" class="form-control" name="tiket" id="tiket" value="<?php echo $row['id_pesan'].' - '.$row['nama'];?>" placeholder="Username Baru" readonly required />
                  </div>
                </div>
				<div class="form-group">
                  <label for="foto" class="col-sm-3 control-label">Bukti Bayar</label>

                  <div class="col-sm-9">
          					<!-- MAX_FILE_SIZE must precede the file input field -->
          					<input type="hidden" name="MAX_FILE_SIZE" value="10000000" />
                    <input type="file" name="bukti" id="bukti" placeholder="Bukti" required />
                  </div>
                </div>
              </div>
              <!-- /.box-body -->
              <div class="box-footer">
				<a type="button" class="btn btn-danger" href="tiketku.php">Cancel</a>
                <button type="submit" class="btn btn-primary pull-right">Upload Bukti Transfer</button>
              </div>
              <!-- /.box-footer -->
							<?php } ?>
			  </div>
        ...
        <div class="box-body"> 
                <div class="form-group">
                  <label for="user" class="col-sm-2 control-label">AN.</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="nama" id="nama" placeholder="XXX XXXXXX XXXXXX" readonly required />
                  </div>
                </div>
                <div class="form-group">
                  <label for="user" class="col-sm-2 control-label">No. Rek.</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="norek" id="norek" placeholder="xxx.xxx.xxx.xxx" readonly required />
                  </div>
                </div>
